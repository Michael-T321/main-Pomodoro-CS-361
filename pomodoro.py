...
def showAbout(): # same as other help screen without pausing timer
    ...
    print("|                                                                                             |")
    print("|  NOTE: By default, the timer is set to 50 minute work sessions, 10 minutes breaks,          |")
    print("|        and 3 total sessions (session = work session + break session)                        |")
    print("|                                                                                             |")
    print("|  CONTROLS (more controls in help):                                                          |")
...
def showHelpScreen(session, session_num, total_sessions):
    ...
    print("|                                                                                           |")
    print(line)
    input("| Press ENTER to close Help and return... ") # different 
